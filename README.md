...
# How to transfer Shape Key values
By default the add-on will transfer shape key values with the shape keys. If the values were changed afterwards, they can be easily transfered from one object to a banch of others.
1. Do steps 1-4 from the preceding paragraph (see above "How to transfer Shape Keys").
2. Click "Transfer Values" button.
